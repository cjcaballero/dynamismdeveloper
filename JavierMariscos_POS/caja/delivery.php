        ...
        <div class="container">
            <a href="../menuadmin.php?user=<?php echo $usuario ?>"><div class="logo"></div></a>           
                <div class="container admin">
                  ...
                  <div class="row">
                      <h1><strong>A Domicilio</strong></h1>
                          <div class="form-group">
                              ...
                              <?php
                                 ...
                                 $db = Database::connect();
                                      ...
                                      $statement = $db->query('SELECT * FROM catdelivery CP');
                                      while($item = $statement->fetch()) 
                                      {
                                          ...
                                          echo '<a href="InsertaitemCuenta.php?user='.$usuario.'&action='. $item['nombre'] . '&iddelivery='. $item['id'] . '&delivery=si&idCuenta='.$idCuenta.'&action=A Domicilio"><span style="color: white;font-size: x-large;margin-left: 10px; line-height: 65px; text-transform: uppercase; font-weight:bold;">'. $item['nombre'] . '</span><img src='. $item['imagen'] . ' style="width: 100px; height:100px;margin-left:65px;margin-top:-15px;"></a>';
                                          echo '</div>';
                                          echo '</div>';
