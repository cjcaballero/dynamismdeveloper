<?php
    ...
    if(!empty($_POST)) 
    {
        ...
        {
            $db = Database::connect();
            $statement = $db->prepare("INSERT INTO catEmployees (nombre,direccion,telefono,celular,idestadocivil,idlugarnacimiento
                                                              ,fechanacimiento,email,fechaingreso,idpagosalario,horarioentrada
                                                              ,horariosalida,salariodiario,salariototal,foto,idestatus) 
                                                               values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            $statement->execute(array($name,$direccion,$telefono,$celular,$estadocivil,$lnacimiento,$fnacimiento,$email,$fingreso,
                                        $salario,$hentrada,$hsalida,$diario,$sueldo,$image,1));
            Database::disconnect();
    ...
    <body>
        <div class="container">
         ...
         <div class="container admin">
            ...
            <div class="row">
                <h1><strong>Alta de Empleados</strong></h1>
                <br>
                <form class="form" action="altaEmpleados.php?user=<?php echo $user ?>" class="form" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-12 col-md-4 table-responsive" style="margin-left: -13px;">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="fnacimiento" step="1" min="1900-01-01" max="3000-12-31" value="<?php echo date("Y-m-d");?>">
                    ...
                    <div class="col-xs-12 col-md-4 table-responsive">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="fingreso" step="1" min="1900-01-01" max="3000-12-31" value="<?php echo date("Y-m-d");?>">
