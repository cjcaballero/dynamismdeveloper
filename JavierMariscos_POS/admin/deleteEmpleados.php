<?php
    ...
    if(!empty($_POST)) 
    {
        ...
        $db = Database::connect();
        $statement = $db->prepare("DELETE FROM catEmployees WHERE id = ?");
        $statement->execute(array($id));
        Database::disconnect();
        header("Location: empleados.php?user=$usuario"); 
    }
            ...
            <a href="empleados.php?user=<?php echo $usuario ?>"><div class="logo"></div></a>
                 <div class="container admin">
                    ...
                    <div class="row">
                        ...
                        <br>
                        <form class="form" action="deleteEmpleados.php?user=<?php echo $usuario ?>" role="form" method="post">
