    ...
    <body>
         <div class="container">
            ...
            <a href="../index.html"><div class="logo"></div></a>
             ...
             <div class="container admin" style="width: 500px;">
                    <div class="row">
                        <h1 style="text-align: center;"><strong>Bienvenido a la Intranet <span style="color: #32C1E8; font-weight: bold; text-align: center;">Bocadito</span></strong></h1>
                        <br>
                        <form class="form" action="loginadmin.php" role="form" method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-success"><span></span>Entrar</button>
                                <a class="btn btn-primary" href="../index.html"><span class="glyphicon glyphicon-arrow-left"></span> Regresar</a>
                                <span class="help-inline"><?php echo $datosError;?></span>
                           </div>
                        </form>
                    </div>
                </div>
